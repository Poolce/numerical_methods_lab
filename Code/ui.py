...
"font: 48pt \"YouYuan\";")
        ...
        self.tableWidget.setGeometry(QtCore.QRect(0, 320, 912, 111))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox.setItemText(2, _translate("Dialog", "5*(x^4)"))
        self.comboBox.setItemText(3, _translate("Dialog", "8*x^3"))
        self.comboBox.setItemText(4, _translate("Dialog", "12*(x^11)"))
        self.comboBox.setItemText(5, _translate("Dialog", "3*x^2"))
        ...
        item.setText(_translate("Dialog", "Error proc(%)"))
        ...
        item.setText(_translate("Dialog", "Current"))
    ...
    def on_click_button(self):
        ...
        self.tableWidget.setItem(0,3,QtWidgets.QTableWidgetItem(str(s[0][3])))
        self.tableWidget.setItem(1,0,QtWidgets.QTableWidgetItem(str(s[1][0])+"%"))
        self.tableWidget.setItem(1,1,QtWidgets.QTableWidgetItem(str(s[1][1])+"%"))
        self.tableWidget.setItem(1,2,QtWidgets.QTableWidgetItem(str(s[1][2])+"%"))
        self.tableWidget.setItem(1,3,QtWidgets.QTableWidgetItem(str(s[1][3])+"%"))
